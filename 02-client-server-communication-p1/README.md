...
Strong params must be used to easily pass params. 
...
```
# When validations fail, the new changes are not added to the DB. When testing your validations, you can confirm the failure in a few ways. For example, if you look at an instance of a failed validation, it will not have an id.
